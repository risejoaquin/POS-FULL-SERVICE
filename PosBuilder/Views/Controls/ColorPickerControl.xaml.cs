...
namespace PosBuilder.Views.Controls
{
    public partial class ColorPickerControl : UserControl
    {
        ...
        public event EventHandler<string>? ColorChanged; // PHASE 7F PosBuilder nullability hygiene applied
        ...
        public ColorPickerControl()
        {
            ...
            {
                Palette.Add(new PaletteColor { Hex = hex, Brush = new SolidColorBrush(ParseColorOrDefault(hex)) }); // PHASE 7F PosBuilder nullability hygiene applied
            }
        ...
        private void HexInput_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            {
                SelectedColor = hex;
                ColorPreview.Background = new SolidColorBrush(ParseColorOrDefault(hex));
        ...
        private void OpenColorPicker_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var color = ParseColorOrDefault(SelectedColor);
        ...
        private static Color ParseColorOrDefault(string hex)
        {
            ...
            return converted is Color color ? color : Color.FromRgb(37, 99, 235); // PHASE 7F PosBuilder nullability hygiene applied
        }
    ...
    {
        public string Hex { get; set; } = string.Empty; // PHASE 7F PosBuilder nullability hygiene applied
        public SolidColorBrush Brush { get; set; } = new SolidColorBrush(Colors.Transparent); // PHASE 7F PosBuilder nullability hygiene applied
    }
}
