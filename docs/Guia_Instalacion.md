...
3. Ejecute la aplicación o constrúyala para despliegue:
   ...
   dotnet run
   ```
   *Nota: Al iniciar, el servidor ejecutará automáticamente las migraciones para crear la estructura de tablas. El primer usuario administrador y la licencia correspondiente de cada tenant se crean de forma segura durante el proceso de aprovisionamiento.*
