...
namespace PosCore
{
    ...
    public class BarcodeProcessor
    {
        ...
        public BarcodeProcessor(object? dbContext = null)
        {
            if (App.ServiceProvider != null)
            {
                _productLookupService = (IProductLookupService?)App.ServiceProvider.GetService(typeof(IProductLookupService));
            }
        }

        public BarcodeProcessor(IProductLookupService productLookupService)
        {
        ...
        public Product? LookupProduct(string code)
        {
            ...
            if (_productLookupService == null) return null;

            var result = _productLookupService.LookupByBarcodeAsync(code).GetAwaiter().GetResult();
