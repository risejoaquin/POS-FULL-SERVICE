    ...
    public partial class PaymentWindow : Window
    {
        ...
        private void UpdateState()
        {
            ...
            if (potentialTotalPaid > Total)
            {
                ...
                ChangeText.Foreground = (System.Windows.Media.Brush)(new System.Windows.Media.BrushConverter().ConvertFrom("#059669") ?? System.Windows.Media.Brushes.Green);
            }
            else
            {
                ChangeText.Text = "$0.00";
                ChangeText.Foreground = (System.Windows.Media.Brush)(new System.Windows.Media.BrushConverter().ConvertFrom("#94A3B8") ?? System.Windows.Media.Brushes.Gray);
            }
        }
        ...
        private void BtnPay_Click(object sender, RoutedEventArgs e)
        {
            ...
            // UX Fast-track: auto-add cash if amount was typed but not added
            if (_tendered > 0 && Payments.Count == 0)
            {
                Payments.Add(new PaymentEntry { Method = "Efectivo", Amount = _tendered });
                _inputBuffer = "";
                UpdateState();
            }
            // UX Fast-track: auto exact cash if nothing was typed and no payments added
            else if (_tendered == 0 && Payments.Count == 0)
            {
                Payments.Add(new PaymentEntry { Method = "Efectivo", Amount = Total });
                UpdateState();
            }
