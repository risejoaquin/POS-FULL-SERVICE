...
public class LicenseService
{
    ...
    private bool CheckOfflineMode()
    {
        ...
        MessageBox.Show("No se puede iniciar el sistema. No hay una licencia válida registrada y no se ha podido contactar con el servidor.", "Error de Licencia", MessageBoxButton.OK, MessageBoxImage.Error);
        return false;
    }
}
