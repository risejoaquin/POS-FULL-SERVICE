...
new_fields = """                    <TextBlock Text="Variantes / Modificadores Rápidos (Separados por coma)" FontSize="14" FontWeight="SemiBold" Foreground="{StaticResource TextSecondaryBrush}" Margin="0,10,0,5"/>
                    ...
                    <TextBox Text="{Binding NotasCocina, UpdateSourceTrigger=PropertyChanged}" Height="40" Margin="0,0,0,25" Padding="10,0" FontSize="14" BorderBrush="{StaticResource BorderBrush}" BorderThickness="1" Background="{StaticResource BackgroundBrush}" VerticalContentAlignment="Center" GotFocus="TextBox_GotFocus"/>
"""

content = re.sub(
    r'(<StackPanel Orientation="Horizontal" HorizontalAlignment="Right">)',
    new_fields + r'\n                    \1',
    content
)
